document.addEventListener("DOMContentLoaded", function() {
    ...
    function loadFolders() {
        const folders = [
            { title: 'Culto de Santa Ceia', date: '10/10/2024 | Noite', path: 'fotos/13-10 NOITE' },
            { title: 'Culto de Santa Ceia', date: '10/10/2024 | Manhã', path: 'fotos/13-10 MANHÃ' },
            { title: 'Culto de Primícias', date: '10/10/2024 | Noite', path: 'fotos/06-10 NOITE' },
            { title: 'Culto de Primícias', date: '10/10/2024 | Manhã', path: 'fotos/06-10 MANHÃ' },
